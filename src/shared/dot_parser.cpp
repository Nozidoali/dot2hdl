...
//                 }
        ...
        if ( nodes[components_in_netlist].type == "Buffer" && nodes[components_in_netlist].slots == 1 )
        {
            ...
            {
                nodes[components_in_netlist].type = "OEHB"; //Carmine 21.02.22 in case of an opaque single slot the component OEHB should used, not EB
            }
        ...
        if ( nodes[components_in_netlist].type == "Buffer" && nodes[components_in_netlist].slots == 2 )
        {
            ...
            {
                nodes[components_in_netlist].type = "nFifo"; //Carmine 21.02.22 in case of an opaque multiple slot the component nFifo should used, not EB
            }
            nodes[components_in_netlist].component_operator = nodes[components_in_netlist].type;
        }
